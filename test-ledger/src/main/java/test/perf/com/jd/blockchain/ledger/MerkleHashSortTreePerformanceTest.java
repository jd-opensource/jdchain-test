...
public class MerkleHashSortTreePerformanceTest {
	...
	public static void main(String[] args) {
		confirm("Are you ready? Press 'OK' to continue... \r\n");
		
		testPerformace1(100, 1000);
		
		confirm("\r\nCompleted test! Do you want to quit? Press 'OK' to continue... \r\n");
	}
...
//		System.out.println(String.format(format, args));
		String ok ;
		do {
			ok = ConsoleUtils.confirm(format, args);
		} while (!"OK".equalsIgnoreCase(ok.trim()));
	}
