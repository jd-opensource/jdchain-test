...
/**
 * @Author: zhangshuang
 * @Date: 2020/6/9 3:47 PM
 * Version 1.0
 */
public class Utils5Nodes {
    ...
    public static final String[] PUB_KEYS = { "3snPdw7i7PjVKiTH2VnXZu5H8QmNaSXpnk4ei533jFpuifyjS5zzH9",
            ...
            "3snPdw7i7PkdgqiGX7GbZuFSi1cwZn7vtjw4vifb1YoXgr9k6Kfmis"};
    ...
    public static Properties loadConsensusSetting() {
        ClassPathResource ledgerInitSettingResource = new ClassPathResource("bftsmart-ledger2.config");
        try (InputStream in = ledgerInitSettingResource.getInputStream()) {
