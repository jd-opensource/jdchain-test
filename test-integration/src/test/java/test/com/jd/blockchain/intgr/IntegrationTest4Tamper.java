...
public class IntegrationTest4Tamper {
...
//                    validKeyPair(userResponse, ledgerRepository, IntegrationBase.KeyPairType.USER);
	...
	private void txTamper(String ledgerHash, String ip, int port, long blockHeight) {
		try {
			String url = "http://" + ip + ":" + String.valueOf(port) + "/management/ledger/tx/tamper";
