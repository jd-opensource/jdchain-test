...
public class IntegrationTestDataAccount {
	...
	public void startPeer() {
		...
		PeerServer peer0 = new PeerServer(peerSrvAddr0, node0.getBindingConfig(), node0.getStorageDB(), null);

		NetworkAddress peerSrvAddr1 = new NetworkAddress("127.0.0.1", 14210);
		PeerServer peer1 = new PeerServer(peerSrvAddr1, node1.getBindingConfig(), node1.getStorageDB(), null);

		NetworkAddress peerSrvAddr2 = new NetworkAddress("127.0.0.1", 14220);
		PeerServer peer2 = new PeerServer(peerSrvAddr2, node2.getBindingConfig(), node2.getStorageDB(), null);

		NetworkAddress peerSrvAddr3 = new NetworkAddress("127.0.0.1", 14230);
		PeerServer peer3 = new PeerServer(peerSrvAddr3, node3.getBindingConfig(), node3.getStorageDB(), null);
	...
	private void testAddKvOpToDataAccount(GatewayTestRunner gateway, AsymmetricKeypair adminKey,
		...
		DataAccountCollection dataAccountSet = ledgerRepository.getDataAccountSet(ledgerRepository.retrieveLatestBlock());
